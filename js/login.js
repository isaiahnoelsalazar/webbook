function login(){
    ...
    requestLogin.open("GET", `https://sharenetarchive1.pythonanywhere.com/login?username=${document.getElementById("username").value}&password=${document.getElementById("password").value}`, true);
